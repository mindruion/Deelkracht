...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(default=False, verbose_name='Uw studie moet beoordeeld worden door de METC, maar dient nog wel bij Deelkracht te worden geregistreerd. Is deze studie al aangemeld bij een METC?'),
        ),
        migrations.AddField(
            model_name='proposal',
            name='institution',
